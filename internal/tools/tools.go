...
func Register(srv *mcpserver.Server, mgr *workspace.Manager, cfg *config.Config) {
	srv.RegisterTool(mcpserver.Tool{
		Name:        "load_data",
		Description: "Load a host file into the workspace's DuckDB as a table. file_path must be within allowed_paths. For files generated by execute_code that already live in /work, use load_from_work instead (no allowed_paths setup needed).",
